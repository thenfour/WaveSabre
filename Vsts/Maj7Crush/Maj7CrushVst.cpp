...
{
	return WaveSabreDeviceVSTChunkToMinifiedChunk_Impl<Maj7CrushVst>(deviceName, inpSize, inpData, outpSize, outpData, deltaFromDefaults);
}
...
{
	return new Maj7CrushVst(audioMaster);
}
