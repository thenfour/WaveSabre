  ...
  0, // EEn = 0
		...
		struct Band
		{
			...
			void RecalcFilters()
			{
				...
				//const auto q = mParams.GetDivCurvedValue(BandParamOffsets::Q, gBiquadFilterQCfg);
        const auto reso01 = Param01{mParams.Get01Value(BandParamOffsets::Q)};
				...
				for (size_t i = 0; i < 2; ++i) {
					...
					// 	mParams.GetEnumValue<FilterResponse>(BandParamOffsets::Type),
					// 	mParams.GetFrequency(BandParamOffsets::Freq, FilterFreqConfig),
					// 	mParams.GetDivCurvedValue(BandParamOffsets::Q, gBiquadFilterQCfg),
					// 	mParams.GetScaledRealValue(BandParamOffsets::Gain, gEqBandGainMin, gEqBandGainMax, 0)
					// );
