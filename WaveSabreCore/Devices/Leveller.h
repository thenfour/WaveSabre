...
static constexpr int16_t gLevellerDefaults16[(int)ParamIndices::NumParams] = {
  ...
  0, // DCEn = 0
  16, // ACircuit = 0.00048828125
  24, // ASlope = 0.000732421875
  8, // AResp = 0.000244140625
  5000, // AFreq = 0.15260690450668334961
  16422, // AGain = 0.50115966796875
  10977, // AQ = 0.334991455078125
  32767, // AEn = 1
  16, // BCircuit = 0.00048828125
  24, // BSlope = 0.000732421875
  40, // BResp = 0.001220703125
  9830, // BFreq = 0.29998779296875
  16384, // BGain = 0.5
  16384, // BQ = 0.5
  0, // BEn = 0
  16, // CCircuit = 0.00048828125
  24, // CSlope = 0.000732421875
  40, // CResp = 0.001220703125
  16834, // CFreq = 0.51373291015625
  16384, // CGain = 0.5
  16384, // CQ = 0.5
  32767, // CEn = 0.999969482421875
  16, // DCircuit = 0.00048828125
  24, // DSlope = 0.000732421875
  40, // DResp = 0.001220703125
  21577, // DFreq = 0.658477783203125
  16384, // DGain = 0.5
  16384, // DQ = 0.5
  0, // DEn = 0
  16, // ECircuit = 0.00048828125
  24, // ESlope = 0.000732421875
  0, // EResp = 0
  26500, // EFreq = 0.8087158203125
  16422, // EGain = 0.50115966796875
  10977, // EQ = 0.334991455078125
  0, // EEn = 0
};
