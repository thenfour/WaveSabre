...
struct ParamAccessor
{
  ...
  float* GetOffsetParamCache()
  {
    return mParamCache + mBaseParamID;
  }
...
public:
  explicit QuickParam(float val01)
      : mBacking(val01)
      , mHasValue(true)
  {
  }
  ...
  QuickParam(float val01, const FreqParamConfig& cfg)
      : mHasValue(true)
      , mBacking(val01)
      , mHasFreqCfg(true)
      , mFreqCfg(cfg)
  ...
  explicit QuickParam(const FreqParamConfig& cfg)
      : mHasFreqCfg(true)
      , mFreqCfg(cfg)
  {
  }

  QuickParam(float val01, const PowCurvedParamCfg& cfg)
      : mHasValue(true)
      , mBacking(val01)
      , mHasPowCurvedCfg(true)
      , mPowCurvedCfg(cfg)
  {
  }
  explicit QuickParam(const PowCurvedParamCfg& cfg)
      : mHasPowCurvedCfg(true)
      , mPowCurvedCfg(cfg)
  {
  }

  QuickParam(float val01, const DivCurvedParamCfg& cfg)
      : mHasValue(true)
      , mBacking(val01)
      , mHasDivCurvedCfg(true)
      , mDivCurvedCfg(cfg)
  {
  }
  explicit QuickParam(const DivCurvedParamCfg& cfg)
      : mHasDivCurvedCfg(true)
      , mDivCurvedCfg(cfg)
  {
  }

  QuickParam(float val01, const VolumeParamConfig& cfg)
      : mHasValue(true)
      , mBacking(val01)
      , mHasVolumeCfg(true)
      , mVolumeCfg(cfg)
  ...
  explicit QuickParam(const VolumeParamConfig& cfg)
      : mHasVolumeCfg(true)
      , mVolumeCfg(cfg)
  {
  }
