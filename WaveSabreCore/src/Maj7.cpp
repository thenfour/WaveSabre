...
namespace WaveSabreCore {
  namespace M7 {
    ...
    const int16_t gDefaultLFOParams[8] = {
      8, // LFO1wav = 0.0002470355830155313015
      16384, // LFO1shA = 0.5
      16384, // LFO1shB = 0.5
      0, // LFO1rst = 0
      16384, // LFO1ph = 0.5
    ...
    const int16_t gDefaultOscillatorParams[19] = {
      ...
      8, // O1Wave = 0.0002470355830155313015
      16384, // O1ShpA = 0.5
      16384, // O1ShpB = 0.5
      0, // O1PRst = 0
      16384, // O1Poff = 0.5
    ...
    const int16_t gDefaultFilterParams[7] = {
      0, // F1En = 0
      72, // F1Circ = 0.0022233200725167989731
      56, // F1Slop = 0.001729249022901058197
      8, // F1Resp = 0.0002470355830155313015
