...
enum class SourceModParamIndexOffsets  // : uint8_t // MUST BE IN SYNC WITH ABOVE
{
  Volume,  // keep in sync between SourceModParamIndexOffsets, OscModParamIndexOffsets, SamplerModParamIndexOffsets, ModDestination
  Pan,
  HiddenVolume,
};
enum class
    OscModParamIndexOffsets  // : uint8_t // MUST BE IN SYNC WITH ABOVE // keep in sync between SourceModParamIndexOffsets, OscModParamIndexOffsets, SamplerModParamIndexOffsets, ModDestination
{
  Volume,  // keep in sync between SourceModParamIndexOffsets, OscModParamIndexOffsets, SamplerModParamIndexOffsets, ModDestination
...
enum class SamplerModParamIndexOffsets  // : uint8_t // MUST BE IN SYNC WITH ABOVE
{
  Volume,  // keep in sync between SourceModParamIndexOffsets, OscModParamIndexOffsets, SamplerModParamIndexOffsets, ModDestination
  Pan,  // keep in sync between SourceModParamIndexOffsets, OscModParamIndexOffsets, SamplerModParamIndexOffsets, ModDestination
  HiddenVolume,  // keep in sync between SourceModParamIndexOffsets, OscModParamIndexOffsets, SamplerModParamIndexOffsets, ModDestination
...
struct ModulationSpec
{
  ...
  void SetSourceAmp(ModSource mAmpEnvModSourceID,
                    ...
                    const bool* pDestSourceEnabledCached)
  {
...
struct ModMatrixNode
{
  ...
  ModDestination mModSpecLastDestinations[(size_t)gModulationCount]
                                         [gModulationSpecDestinationCount];  // = { ModDestination::None };
  ...
  template <typename Tmodid, typename ToffsetId>
  inline real_t GetDestinationValue(Tmodid id, ToffsetId offset) const
  {
    //static_assert(std::is_convertible_v<Tmodid, size_t>, "id must convertible to int");
    //static_assert(std::is_convertible_v<ToffsetId, size_t>, "offset must be convertible to int");
...
struct LFOInfo
{
  GigaSynthParamIndices mParamBase;
...
struct SourceInfo
{
  ...
  GigaSynthParamIndices mParamBase;
  GigaSynthParamIndices mAmpParamBase;
