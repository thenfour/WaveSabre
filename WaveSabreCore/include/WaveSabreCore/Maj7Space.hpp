...
#define MAJ7SPACE_PARAM_VST_NAMES(symbolName) static constexpr char const* const symbolName[(int)::WaveSabreCore::Maj7Space::ParamIndices::NumParams]{ \
	{"OutputVolume"},\
}

		static_assert((int)Maj7Space::ParamIndices::NumParams == 1, "param count probably changed and this needs to be regenerated.");
