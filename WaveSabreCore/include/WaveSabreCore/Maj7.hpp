...
namespace WaveSabreCore
{
	namespace M7
	{
		...
		struct Maj7 : public Maj7SynthDevice
		{
			...
			//{
			//	return 0; // should never get called; the VST does its own serialization in the VST level. then the minified chunk is generated by the VST as well via project manager.
