...
#define MAJ7ANALYZE_PARAM_VST_NAMES(symbolName) static constexpr char const* const symbolName[(int)::WaveSabreCore::Maj7Analyze::ParamIndices::NumParams]{ \
	{"Outp"},\
}

		static_assert((int)Maj7Analyze::ParamIndices::NumParams == 1, "param count probably changed and this needs to be regenerated.");
		...
		AnalysisStream mLoudnessAnalysis[2];
