...
inline bool ToggleButton(bool* value,
                         const char* label,
                         ImVec2 size = {},
...
struct ParamExplorer
{
  ...
  void Render()
  {
    ...
    ImGuiKnobs::Knob("Div curved##div",
                     &mDivKnobValue,
                     0,
                     1,
                     0,
    ...
    RenderTransferCurve({300, 300},
                        {
                            {[&](float x01)
                             ...
                             ColorFromHTML("444444", 0.5f),
                             1.0f},
                            {[&](float x01)
                             {
                               return transferPow01(x01);
                             },
                             powColor,
                             2.0f},
                            {[&](float x01)
                             {
                               return transferDiv01(x01);
                             },
                             divColor,
                             2.0f},
