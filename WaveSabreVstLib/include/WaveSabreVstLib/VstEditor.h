...
public:
  ...
  bool BeginTabBar2(const char *str_id, ImGuiTabBarFlags flags,
                    float width = 0) {
    return WaveSabreVstLib::BeginTabBar2(str_id, flags, tabBarBB,
                                         tabBarStoredSeparatorColor, width);
  }

  bool WSBeginTabItem(const char *label, bool *p_open = 0,
                      ImGuiTabItemFlags flags = 0) {
    return WaveSabreVstLib::WSBeginTabItem(label, tabBarStoredSeparatorColor,
                                           p_open, flags);
  }
  ...
  bool WSBeginTabItemWithSel(const char *label, int thisTabIndex,
    ...
    return WaveSabreVstLib::WSBeginTabItemWithSel(label, thisTabIndex, helper,
                                                  tabBarStoredSeparatorColor);
  }

  void EndTabBarWithColoredSeparator() {
    WaveSabreVstLib::EndTabBarWithColoredSeparator(tabBarBB,
                                                   tabBarStoredSeparatorColor);
  }
